...
(function(){
  const QUEST_LINKS = {
    ...
    quiz: "https://docs.google.com/document/d/1Ixoc3qxps1rgiYfAb62XYOesA49ho_L2pdOCAroSJN8/edit?usp=sharing",             // 퀴즈
    virtualClass: "https://docs.google.com/document/d/1Ixoc3qxps1rgiYfAb62XYOesA49ho_L2pdOCAroSJN8/edit?usp=sharing",     // 가상교실탐사
    reading: "https://docs.google.com/document/d/1Ixoc3qxps1rgiYfAb62XYOesA49ho_L2pdOCAroSJN8/edit?usp=sharing",          // 책 읽기
    writing: "https://docs.google.com/document/d/1Ixoc3qxps1rgiYfAb62XYOesA49ho_L2pdOCAroSJN8/edit?usp=sharing"           // 학습지
  };
  ...
  function ensurePanel(){
    ...
    const quests = [
      { key: "worksheet", label: "학습지", desc: "오늘의 학습지로 실력을 다져요." },
      { key: "quiz", label: "퀴즈", desc: "가볍게 문제를 풀며 복습해요." },
      { key: "virtualClass", label: "가상교실탐사", desc: "온라인 교실이나 가상 체험으로 떠나요." },
      { key: "reading", label: "책 읽기", desc: "조용히 책을 읽으며 생각을 정리해요." },
      { key: "writing", label: "시간표", desc: "오늘의 수업 시간표를 확인해봐요." }
    ];
